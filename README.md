...
```
wget https://github.com/mrmahile/gitxpose/releases/download/v0.0.2/gitxpose-linux-amd64-0.0.2.tgz
tar -xvzf gitxpose-linux-amd64-0.0.2.tgz
rm -rf gitxpose-linux-amd64-0.0.2.tgz
...
```
git clone --depth 1 https://github.com/mrmahile/gitxpose.git
